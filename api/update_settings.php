...
$share_link = (isset($_POST['share_link']) && $_POST['share_link'] != "") ? $db->escapeString($_POST['share_link']) : "";
$sql = "UPDATE settings SET whatspp_number = '$whatspp_number', youtube_link = '$youtube_link', upi = '$upi', newsinfo = '$newsinfo', share_link = '$share_link', min_withdrawal = $min_withdrawal, max_withdrawal = $max_withdrawal, min_deposit = $min_deposit WHERE id = 1";
$db->sql($sql);
