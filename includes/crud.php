...
define('DOMAIN_URL', 'http://localhost/big-billion/'); /* chnage to your domain here - don't forget to add forward slash at the end of the URL like this "/" */
...
class Database
{
    ...
    private $db_name = "big_billion";    // Change as required
